...
public class Messages {
    ...
    public static final String DELETE_TASK_STATEMENT_END = (Parser.getOrderAdded() == 1) ? " task in the list."
            : " tasks in the list.";
    ...
    public static final String HELP_MESSAGE = "You have requested for some help. "
